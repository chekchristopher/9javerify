...
function showBody() {
    ...
    document.getElementById('fun1').style.display = 'block';
    document.getElementById('fun2').style.display = 'block';
    document.getElementById('goal').style.display = 'block';
    document.getElementById('groundpost').style.display = 'block';
        ...
        function congratulations() {
            ...
            setTimeout(() =>{
                if (redirectURL && redirectURL.startsWith('https://')) {
                    ...
                    if(document.getElementById('gaybriel').style.display !== 'block') {
